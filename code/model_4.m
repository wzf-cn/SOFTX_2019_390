%% Predictive theoretical model of PER #4
    % Model of upper bound for OFDM system, with model to obtain the BER #1.
    %% *Syntax*
    % PER = model_4(SNR, M, r, l)
    %% *Description*
    % The model_4(SNR, M, r, l) function describes a model for calculating 
    ...
    %
    %% *Examples*
    % The model_4(SNR, M, r, l) function is called.
function PER = model_4(SNR, M, r, l)
%%
    % The BER value is obtained with modeloBER1() and depends on the SNR, 
